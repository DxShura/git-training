console.log('test211155555');

/**
 * gco -d nomdebranche
 * gco nom de branche pour switch
 * 
 * dans vscode faire ctrl+maj+p et chercher git checkout pour switch de branch
 * 
 * faire des changement dans la branche 
